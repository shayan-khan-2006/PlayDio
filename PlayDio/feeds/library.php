...
<div class="container">
    <div class="flex-div lb_wrapper">
        <div class="left_lb flex-col">
            <div class="flex-col">
            ...
            <h2>Watch Later</h2>
                ...
                if (isset($_SESSION['uid'])) {
                    ...
                    $user_id = $_SESSION['uid']; // Replace with the actual user ID
                    $watch_later_query = "SELECT videos.*, channels.* FROM videos
                    INNER JOIN channels ON videos.channel_id = channels.c_id
                    INNER JOIN watch_later ON videos.v_id = watch_later.video_id
                    WHERE watch_later.user_id = {$user_id}";
                    $watch_later_result = mysqli_query($conn, $watch_later_query);

                    if (mysqli_num_rows($watch_later_result) > 0) {
                        while ($row = mysqli_fetch_assoc($watch_later_result)) {
                ...
                ?>
                            <div class="flex-div row_lb">
                                <div class="side-video-list flex-col">
                                    <a href="watch.php" class="small-thumbnail">
                                    ...
                                    <div class="video-info">
                                        ...
                                        <p class="v-views">
                                            <?php echo $row['v_views']; ?> views &bull; <?php echo $timeAgo ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="flex-col">
                ...
                <div class="flex-div">
                    <div class="side-video-list flex-col">
                        <a href="watch.php" class="small-thumbnail">
                            <img src="../video_thumbnail/thumbnail1.png">
                        </a>
                        <div class="video-info">
                            <a>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a>
                            <p class="c-title">Lorem, ipsum dolor.</p>
                            <p class="v-views">1000 Views &bull; 1 month ago </p>
                        </div>
                    </div>
                </div>
            </div>
