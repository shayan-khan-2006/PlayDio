        ...
        ?>
                ...
                <div class="videos">
                    ...
                    <div class="flex-div">
                        ...
                        <a class="subscribe-btn remove-btn" data-video-id="<?php echo $row['v_id']; ?>">Remove From Watch Later</a>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        // Attach click event to the "Remove From Watch Later" button
        $('.remove-btn').on('click', function(event) {
            ...
            // Send an AJAX request to the server to remove the video from Watch Later
            $.ajax({
                url: '../controllers/remove_wl.php',
                type: 'POST',
                data: {
                    remove_video: 1,
                    v_id: videoId,
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        // Remove the video element from the page after successful removal
