<div class="sidebar">
    <div class="sidebar-links">
        ...
        <a href="#">
            <!-- spark star scg -->
            <!-- <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-sparkles" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--black)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <a href="feeds/watch_later.php">
            <svg width="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <a class="customize">
            ...
            <p>Customize</p>
            <svg width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--gray)" fill="none" stroke-linecap="round" stroke-linejoin="round" id="customize-pop-btn">
...
<div class="customize-popup">
    ...
    <div class="customize-colors">
        <span data-color="#ff0800" class="single-color active" style="background-color: #ff0800;"></span>
