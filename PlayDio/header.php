    ...
    <nav class="flex-div">
        ...
        <a class="nav-left flex-div">
            ...
            <div class="logo-icon">
                ...
                <svg viewBox="28.307 12.581 320.723 334.352" width="30" height="30">
        ...
        <div class="nav-middle flex-div">
            <div class="search-box flex-div">
                <form action="result.php" method="GET">
                    ...
                    if (isset($_GET['query']) != "") {
                    ?>
                        <input type="search" placeholder="Ready to Spark?" value="<?php echo $_GET['query']; ?>" name="query" id="search_input" onkeyup="handleSearch(event)" autocomplete="off">
                    <?php
                    } else {
                    ?>
                        <input type="search" placeholder="Ready to Spark?" name="query" id="search_input" onkeyup="handleSearch(event)" autocomplete="off">
                    <?php
                    }
                    ?>
                    <div class="search-history-dropdown" id="search_history_dropdown">
                    ...
                    <!-- search svg -->
                    <button type="submit">
                        <svg class="search_svg search-icon" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--black)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div class="nav-right flex-div">
            ...
            <a href="marketplace.php" target="_blank">
                <svg width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--black)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M3 21l18 0" />
                    <path d="M3 7v1a3 3 0 0 0 6 0v-1m0 1a3 3 0 0 0 6 0v-1m0 1a3 3 0 0 0 6 0v-1h-18l2 -4h14l2 4" />
                    <path d="M5 21l0 -10.15" />
                    <path d="M19 21l0 -10.15" />
                    <path stroke="var(--main-color)" fill="var(--main-color)" d="M9 21v-4a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v4" />
                </svg>
            </a>
            <!-- bell svg -->
            <svg width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--black)" fill="none" stroke-linecap="round" stroke-linejoin="round">
